...
class GameStatus:
    ...
    def encounter(self):
        ...
        while self.player.health > 0 and enemy.health > 0:
            # Player's turn
            print(f"Your health: {self.player.health}, Your stamina: {self.player.stamina}")
            ...
            print(f"C) special attack (Inflict {self.player.special_attack_damage} damage)")
            print(f"D) Quit game")
            ...
            if player_action == "A":
                ...
                if self.player.stamina < 20:
                    print("\nYou don't have enough stamina to use this attack!")
                    continue

                player_damage = self.player.special_attack(enemy)
                print(
                    f"\nYou used {self.player.special_attack_name}!")
                self.player.stamina -= 20
                enemy.health -= self.player.special_attack_damage
